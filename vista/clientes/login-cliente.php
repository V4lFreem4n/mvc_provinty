...
<body class="bg-gradient-to-r from-blue-700 via-blue-500 to-green-400 flex items-center justify-center min-h-screen p-4">
        ...
        <div class="header-bg p-6 mb-8 relative">
            <div class="flex items-center justify-between">
                <div class="logo-container">
                    <img src="../vista/clientes/img/logo_provint.png" alt="Company Logo" class="h-12 w-auto"/>
                </div>
